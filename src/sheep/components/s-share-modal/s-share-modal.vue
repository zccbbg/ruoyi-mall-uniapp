      ...
      <view class="share-box">
        <view class="share-list-box ss-flex">
          ...
          >
            <image
              class="share-img"
              :src="sheep.$url.static('https://git-open.oss-cn-shenzhen.aliyuncs.com/ruoyi-mall/uniapp/icons/share_poster.png')"
              mode=""
            ></image>
          ...
          >
            <image
              class="share-img"
              :src="sheep.$url.static('https://git-open.oss-cn-shenzhen.aliyuncs.com/ruoyi-mall/uniapp/icons/share_link.png')"
              mode=""
            ></image>
